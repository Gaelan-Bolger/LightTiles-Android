...
public class AccessPointSlide extends Fragment implements ISlidePolicy {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new AccessPointAdapter(getActivity(), (holder, item) -> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        inflater.inflate(R.layout.slide_content_ap_select, view.findViewById(R.id.frame_bottom), true);
        bind(this, view);
        ...
        vRecyclerView.addItemDecoration(new DividerItemDecoration(requireActivity(), DividerItemDecoration.VERTICAL));
        vRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        vRecyclerView.setAdapter(mAdapter);

        vConnectManually.setOnClickListener(v -> IpRequestDialog.newInstance(ipAddress -> {
