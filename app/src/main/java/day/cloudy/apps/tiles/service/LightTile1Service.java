 ...
 */
public class LightTile1Service extends LightTileService {

    private static final String TAG = LightTile1Service.class.getSimpleName();

    @NonNull
    protected TileComponent getTileComponent() {
        return TileComponent.TILE_1;
    }
}
