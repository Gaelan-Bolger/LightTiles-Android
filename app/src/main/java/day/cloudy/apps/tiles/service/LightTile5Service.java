 ...
 */
public class LightTile5Service extends LightTileService {

    private static final String TAG = LightTile5Service.class.getSimpleName();

    @NonNull
    protected TileComponent getTileComponent() {
        return TileComponent.TILE_5;
    }
}
