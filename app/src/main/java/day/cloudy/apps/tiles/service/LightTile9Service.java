 ...
 */
public class LightTile9Service extends LightTileService {

    private static final String TAG = LightTile9Service.class.getSimpleName();

    @NonNull
    protected TileComponent getTileComponent() {
        return TileComponent.TILE_9;
    }
}
