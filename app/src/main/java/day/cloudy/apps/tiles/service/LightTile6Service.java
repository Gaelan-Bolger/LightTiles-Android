 ...
 */
public class LightTile6Service extends LightTileService {

    private static final String TAG = LightTile6Service.class.getSimpleName();

    @NonNull
    protected TileComponent getTileComponent() {
        return TileComponent.TILE_6;
    }
}
