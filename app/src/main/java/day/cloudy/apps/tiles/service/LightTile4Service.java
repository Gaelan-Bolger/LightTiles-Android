 ...
 */
public class LightTile4Service extends LightTileService {

    private static final String TAG = LightTile4Service.class.getSimpleName();

    @NonNull
    protected TileComponent getTileComponent() {
        return TileComponent.TILE_4;
    }
}
